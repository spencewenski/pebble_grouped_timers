...
//   int inset_amount = window_bounds.size.h / 4;
//   GRect timer_bounds = grect_inset(window_bounds, GEdgeInsets4(inset_amount, 0, inset_amount, 0));
  ...
  struct Timer* timer = app_data_get_current_timer(app_data);
